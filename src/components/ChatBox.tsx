  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if ("tourId" in reply) {
        ...
        botMsg = { sender: "bot", text: "Xin lỗi, tôi không hiểu phản hồi này." };
      }
    ...
    <>
      ...
      {isOpen && (
        <div
          ...
          style={{ width: "380px", height: "520px", left: position.x, bottom: position.y }}
        >
          {/* Header */}
          <div
          ...
          <div className="flex-1 p-4 overflow-y-auto space-y-4 bg-gray-50">
            ...
            {loading && (
              <p className="text-gray-400 text-sm italic animate-pulse">AI đang trả lời...</p>
            )}
