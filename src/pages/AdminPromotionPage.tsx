...
const ITEMS_PER_PAGE = 6; // Số khuyến mãi mỗi trang
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 bg-white/50 rounded-3xl border border-dashed border-gray-300">
            ...
            <p className="text-gray-500 mt-1">
              Hãy tạo khuyến mãi đầu tiên để thu hút khách hàng!
            </p>
          </div>
        ) : (
          <>
            ...
            <div className="flex justify-center items-center mt-6 gap-2">
              <button
                ...
                className="px-3 py-1 rounded-lg bg-gray-200 text-gray-600 disabled:opacity-50 hover:bg-gray-300 transition"
              >
